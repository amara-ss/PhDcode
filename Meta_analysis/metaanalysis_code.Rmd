...
res <- orchaRd::mod_results(ECM_richness_multilevel, mod = "Fire_type", group = "Study_ID", at=list("Fire_type" = "Prescribed_fire"), subset = TRUE )
res
res1 <- orchaRd::mod_results(ECM_richness_multilevel, mod="Fire_type", group = "Study_ID", at=list("Fire_type" = "Wildfire"), subset = TRUE )
res1
...
res <- orchaRd::mod_results(All_richness_multilevel, mod = "Soil_samples_depth_cm", group = "Study_ID", at=list("Soil_samples_depth_cm" = "Prescribed_fire"), subset = TRUE )
res
res1 <- orchaRd::mod_results(All_richness_multilevel, mod="Soil_samples_depth_cm", group = "Study_ID", at=list("Soil_samples_depth_cm" = "Wildfire"), subset = TRUE )
res1
...
```{r}
ggplot(All_fungi_alpha, aes(x = Time_since_fire_years, y = yi)) +
  ...
  labs(
    ...
    title = "Meta-regression: Saprotroph alpha vs time since fire"
  ) +
  theme_minimal(base_size = 14)
```
...
```{r Publication Bias}
funnel(ECM_result) #we look for symmetry
