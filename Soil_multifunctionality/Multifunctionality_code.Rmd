...
var_log_top <- (log(models_topsoil$densidad_revisada_25)+1)
...
car::Anova(lmf_sub, test.statistic="F", type=3)

multcomp::cld(emmeans(lmf_sub, ~TRAT2, type="response"), Letters=letters) #Tuckey's post-hoc test
