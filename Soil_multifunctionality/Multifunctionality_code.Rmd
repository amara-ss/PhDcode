...
pca_plot <- fviz_pca_biplot(pca_sev,
                ...
                mean.point=F, #No centroids
                label = "none",
                col.var = "#696969", alpha.var=0.3,
                pointsize = 6, alpha.ind = 0.2, 
                pointshape=16,
...
# 3) Create the 6 "soil function" categories: Soil_properties, Nutrient_pools, Soil_carbon, Soil_activity, Heavy_metals,Soil_biota:
aver_mul2 <- trial %>%
  ...
  ungroup()
# 4) Dataframe of the defined soil functions and their mean value: 
soil_functions <- aver_mul2 %>%
