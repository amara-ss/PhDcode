...
guild_rel_summary$TRAT2 <- ordered(guild_rel_summary$TRAT2, levels = c("UB", "LS", "HS1", "HS2"))
guild_rel_summary$DEPTH <- ordered(guild_rel_summary$DEPTH, levels = c("topsoil", "subsoil"))

ggplot(guild_rel_summary, aes(x = TRAT2, y = graph_abun, fill = guild_fg)) +
