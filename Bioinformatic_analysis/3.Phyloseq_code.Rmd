...
alpha_fungi <- microbiome::alpha(ps1, index = c("Observed", "Shannon", "Chao1"))
...
-Significant differences found in *Observed and Chao1 richness*: UB > LS > HS1 > HS2
...
#####TOPSOIL
ps2_topsoil <- subset_samples(ps_hel, DEPTH == "topsoil")
...
#####SUBSOIL
ps2_subsoil <- subset_samples(ps_hel, DEPTH == "subsoil")
