...
order.sum = tapply(phyloseq::taxa_sums(ps1_order), 
                   ...
                   sum, na.rm=TRUE)
top10phyla = names(sort(order.sum, TRUE))[1:6]
ps_TOP = phyloseq::prune_taxa((tax_table(ps1_order)[, "Order"] %in% top10phyla), ps1_order)
ps_TOP
...
cols5 <- RColorBrewer::brewer.pal(6, "Paired")
