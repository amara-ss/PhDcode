...
lmm_depth <- lmer(dominance_dbp ~ TRAT2 + (1|SITE), data = alpha_fungi_TOP)
summary(lmm_depth)
...
env_top <- ggplot(pcoa_top_df_merged, aes(x = PCoA1, y = PCoA2, color = TRAT2)) +
  ...
  stat_ellipse(level = 0.95, linetype = 1, size = 0.2) +  # 95% confidence ellipses
...
combined_plot
ggsave("combined_envfit2.png", width = 6, height = 5, dpi = 300)
```
...
meta_heatmap_top <- alpha_fungi_top[,c(2:4, 35:95)]
...
meta_heatmap_top <- meta_heatmap_top %>% 
...
```{r MODELS: soil physicochemical variables on richness}
#TOPSOIL
...
phychem_lmSUB <- lm(formula = observed ~ C_N_ratio + A_phosphorus_ppm_105 + Phosphatase_activity_µmol_g_h + 
    NH4_mgL_105 + MBC_mg_kg_105 + Mg_g_kg + Al_g_kg , 
    data = alpha_fungi_sub_scaled)
summary(phychem_lmSUB)
...
sem_top_all <- piecewiseSEM::psem(
  lm(observed ~ pc1 + pH + A_phosphorus_ppm_105 + NH4_mgL_105 + 
    MBC_mg_kg_105 + K_g_kg + Mg_g_kg + Al_g_kg, data = alpha_fungi_top),
  lm(pH ~pc1, data = alpha_fungi_top),
  lm(MBC_mg_kg_105~pc1, data = alpha_fungi_top),
  MBC_mg_kg_105%~~%NH4_mgL_105,
  pH%~~%K_g_kg
)
d <- (summary(sem_top_all, .progressBar=F, standardize="range",conserve=TRUE))
write.csv(d$coefficients, "SEM_topsoil_all.csv")

#Subsoil
library(piecewiseSEM)
sem_sub_all <- piecewiseSEM::psem(
  lm(observed ~ pc1 + C_N_ratio + A_phosphorus_ppm_105 + Phosphatase_activity_µmol_g_h + 
    NH4_mgL_105 + MBC_mg_kg_105 + Mg_g_kg + Al_g_kg + Zn_mg_Kg_105, 
    data = alpha_fungi_sub),
  #lm(pH ~pc1, data = alpha_fungi_top),
  lm(MBC_mg_kg_105~pc1, data = alpha_fungi_top),
  MBC_mg_kg_105%~~%NH4_mgL_105,
  MBC_mg_kg_105%~~%C_N_ratio
  #pH%~~%K_g_kg
)
c <- (summary(sem_sub_all, .progressBar=F, standardize="range",conserve=TRUE))
c$coefficients
...
sem_top <- piecewiseSEM::psem(
  lm(ECM_richness ~ pc1 + pH + A_phosphorus_ppm_105 + NH4_mgL_105 + 
    MBC_mg_kg_105 + K_g_kg + Mg_g_kg + Al_g_kg +NO3_mgL_105, data = SEM_df_top),
  lm(USp_richness ~ pc1 + A_phosphorus_ppm_105 + NH4_mgL_105 + 
    SOM_per_corregido + Mg_g_kg + Al_g_kg + Zn_mg_Kg_105 + 
    Cu_mg_Kg_105 + MBC_mg_kg_105 + NO3_mgL_105, data = SEM_df_top),
  lm(LSp_richness ~ pc1+pH + A_phosphorus_ppm_105 + NH4_mgL_105 + 
    Ntotal_g_100g_105 + Ctotal_g_100g_105 + K_g_kg + Fe_g_Kg + 
    Zn_mg_Kg_105, data = SEM_df_top),
  lm(NH4_mgL_105 ~ pc1, data = SEM_df_top),
  lm(MBC_mg_kg_105 ~ pc1, data = SEM_df_top),
  lm(A_phosphorus_ppm_105 ~ pc1, data = SEM_df_top),
  lm(K_g_kg ~ pc1, data = SEM_df_top),
  lm(Mg_g_kg ~ pc1, data = SEM_df_top),
  lm(Al_g_kg ~ pc1 , data = SEM_df_top),
  lm(pH ~ pc1, data = SEM_df_top),
  lm(NO3_mgL_105 ~ pc1, data = SEM_df_top),
  pH%~~%NH4_mgL_105,
  pH %~~% A_phosphorus_ppm_105,
  NH4_mgL_105%~~%MBC_mg_kg_105,
  NH4_mgL_105%~~%A_phosphorus_ppm_105,
  NH4_mgL_105%~~%NO3_mgL_105,
  MBC_mg_kg_105%~~%A_phosphorus_ppm_105,
  NH4_mgL_105%~~%SOM_per_corregido,
  #A_phosphorus_ppm_105%~~%NO3_mgL_105,
  A_phosphorus_ppm_105%~~%SOM_per_corregido,
  K_g_kg%~~%pH,
  Al_g_kg%~~%pH,
  K_g_kg%~~%Zn_mg_Kg_105,
  Mg_g_kg%~~%Zn_mg_Kg_105,
  Al_g_kg%~~%Zn_mg_Kg_105,
  Al_g_kg%~~%A_phosphorus_ppm_105,
  K_g_kg%~~%Cu_mg_Kg_105,
  Mg_g_kg%~~%Cu_mg_Kg_105,
  Al_g_kg%~~%Cu_mg_Kg_105,
  MBC_mg_kg_105%~~%SOM_per_corregido,
  K_g_kg%~~%NH4_mgL_105,
  Mg_g_kg%~~%NH4_mgL_105,
  K_g_kg%~~%SOM_per_corregido,
  Mg_g_kg%~~%SOM_per_corregido,
  Mg_g_kg%~~%K_g_kg,
  Al_g_kg%~~%Mg_g_kg,
  Al_g_kg%~~%K_g_kg,
  K_g_kg%~~%MBC_mg_kg_105,
  Ntotal_g_100g_105%~~%NH4_mgL_105,
  Ntotal_g_100g_105%~~%MBC_mg_kg_105,
  Ntotal_g_100g_105%~~%A_phosphorus_ppm_105,
  Ntotal_g_100g_105%~~%K_g_kg,
  Ntotal_g_100g_105%~~%pH,
  Ctotal_g_100g_105%~~%NH4_mgL_105,
  Ctotal_g_100g_105%~~%MBC_mg_kg_105,
  Ctotal_g_100g_105%~~%A_phosphorus_ppm_105,
  Ctotal_g_100g_105%~~%K_g_kg,
  Ctotal_g_100g_105%~~%pH,
  Fe_g_Kg%~~%K_g_kg,
  Fe_g_Kg%~~%Mg_g_kg,
  Al_g_kg%~~%Fe_g_Kg,
  Al_g_kg%~~%Ntotal_g_100g_105,
  Mg_g_kg%~~%Ctotal_g_100g_105
)
a <- (summary(sem_top, .progressBar=F, standardize="range",conserve=TRUE))
...
sem_sub <- piecewiseSEM::psem(
  lm(ECM_richness ~ pc1 + C_N_ratio + A_phosphorus_ppm_105 + 
    Ntotal_g_100g_105 + SOM_per_corregido + MBC_mg_kg_105 + Ca_g_kg + 
    Mg_g_kg +  Fe_g_Kg, data=SEM_df_sub),
  lm(LSp_richness ~ pc1 + pH + A_phosphorus_ppm_105 + MBC_mg_kg_105 + 
    Mg_g_kg + Fe_g_Kg + Zn_mg_Kg_105 + Ntotal_g_100g_105, data=SEM_df_sub),
  lm(USp_richness ~ pc1 + pH + EC + C_N_ratio + NO3_mgL_105 + 
    Nematode_g_105 + Ca_g_kg + Mg_g_kg + Na_g_kg +  
    Fe_g_Kg + Zn_mg_Kg_105 + Cu_mg_Kg_105, data=SEM_df_sub),
  lm(C_N_ratio ~pc1, data=SEM_df_sub),
  C_N_ratio%~~%Mg_g_kg,
  #C_N_ratio%~~%Al_g_kg,
  C_N_ratio%~~%Fe_g_Kg,
  C_N_ratio%~~%Zn_mg_Kg_105,
  C_N_ratio%~~%Ntotal_g_100g_105,
  C_N_ratio%~~%NO3_mgL_105,
  C_N_ratio%~~%Cu_mg_Kg_105
)
b <- (summary(sem_sub, .progressBar=F, standardize="range",conserve=TRUE))
