...
# Build tree
treeNJ <- NJ(dm) # Neighbor-Joining tree as starting point
...
order.sum = tapply(phyloseq::taxa_sums(ps_ascobasidio), 
                   ...
                   sum, na.rm=TRUE)
top10phyla = names(sort(order.sum, TRUE))[1:10]
...
plot_indval_data <- indicator_with_taxonomy8 %>%
