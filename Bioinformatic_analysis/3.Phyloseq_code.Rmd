...
GP.ord <- ordinate(ps1, "NMDS", "bray")
p1 = plot_ordination(ps1, GP.ord, type="taxa", color="Phylum", title="taxa")
print(p1)

p1 + facet_wrap(~Phylum, 3)

p2 = plot_ordination(ps1, GP.ord, type="TRAT2", color="TRAT2", shape="DEPTH") 
...
###HEATMAP
ggplot(plot_indval_data, aes(x = TRAT2, y = Family, fill = Presence)) +
...
ggsave("indicspecies_fam_heatmap.png")
