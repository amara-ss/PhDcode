---
title: "DADA2 pipeline of Navalacruz 2021 dataset sampling"
...
# 1) Unzip fastq files
#tgz_file <- "Bioinformatic_analysis/Raw_data.tgz"
...
Filtered
str(Filtered)
#write.table(Filtered, "Filtered_Ns.txt") # Hacemos estos pasos para sacar un documento txt con las secuencias input iniciales y las output después del filtrado de N (añadir que en los resultados solamente vendrá reflejado los reads de la secuencia forward, por lo que consideramos que es número de reads por pair sequences, es decir, Fwd-Rvs).
...
trimmed.d <- "Raw_data_firefungi_soil/output_cutadapt"
...
#The database we are using in this case is **UNITE 2022**: https://unite.ut.ee/repository.php --> this is critical because depending on which database we use and even the version, it can drastically change our results.
...
output_folder <- "Raw_data_firefungi_soil/dada2_output_soil/"
...
asv_fasta_file <- paste0(output_folder, "asv_OTU.fasta")
asv_table_file <- paste0(output_folder, "asv_table.csv")
